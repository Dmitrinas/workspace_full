          ...
          return (
            <div key={wo.id} className="bg-white border border-stone-200 p-4 lg:p-5">
              ...
              <div className="flex items-center gap-2 mt-3 pt-3 border-t border-stone-100 flex-wrap">
                <button onClick={() => setModal({ type: 'editWorkOrder',  wo })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><Edit className="w-3 h-3" /> Изменить</button>
                {!inspection && <button onClick={() => setModal({ type: 'confirmInspection',  wo })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><Camera className="w-3 h-3" /> Осмотр</button>}
                ...
                {!act && <button onClick={() => setModal({ type: 'confirmAct',  wo })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><FileText className="w-3 h-3" /> Акт</button>}
            ...
            {filtered.map(p => (
              <tr key={p.id} className="border-b border-stone-100 hover:bg-stone-50">
                ...
                <td className="px-4 py-3 text-right">
                  <button onClick={() => setModal({ type: 'editPart',  p })} className="p-1.5 text-stone-400 hover:text-stone-700"><Edit className="w-3.5 h-3.5" /></button>
          ...
          <tbody>
            {filtered.map(w => (
              <tr key={w.id} className="border-b border-stone-100 hover:bg-stone-50">
                ...
                <td className="px-4 py-3 text-right">
                  <button onClick={() => setModal({ type: 'editWorkItem',  w })} className="p-1.5 text-stone-400 hover:text-stone-700"><Edit className="w-3.5 h-3.5" /></button>
          ...
          return (
            <div key={insp.id} className="bg-white border border-stone-200 p-4 lg:p-5">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setModal({ type: 'editInspection',  insp })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><Edit className="w-3 h-3" /> Изменить</button>
          ...
          return (
            <div key={act.id} className="bg-white border border-stone-200 p-4 lg:p-5">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setModal({ type: 'editAct',  act })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><Edit className="w-3 h-3" /> Изменить</button>
      ...
      <div>
        ...
        <div className="bg-white border border-stone-200 p-5 mb-4">
          <div className="flex items-start justify-between mb-4">
            ...
            <button onClick={() => setModal({ type: 'editClient',  selectedClient })} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] bg-stone-100 text-stone-700 hover:bg-stone-200 uppercase tracking-wide"><Edit className="w-3 h-3" /> Изменить</button>
          </div>
